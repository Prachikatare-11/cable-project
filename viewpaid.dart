...
class ViewpaidCustomer extends StatefulWidget {
  static String routeName = '/viewUnpaidCustomer';

  @override
  State<ViewpaidCustomer> createState() => _ViewpaidCustomerState();
}

class _ViewpaidCustomerState extends State<ViewpaidCustomer> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (res['success'].toString() == "true") {
          ...
          await pref.setString("customerId", (customerId.toString()));
          await pref.setString("connectionId", (connectionId.toString()));

          List<dynamic> allLines = res['paid_arr'] ?? [];
